...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    xmlns:isodates="http://iso" xmlns:local="http://www.local.gov/namespace"
    xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:marccountry="http://www.local.gov/marc/countries"
    xmlns:nalsubcat="http://nal-subject-category-codes" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" 
    ...
    <xd:doc scope="stylesheet" id="Institution-id-LC">
        <xd:desc>
            <xd:ul>
                <xd:li><xd:p><xd:b>XLST Function Library</xd:b></xd:p>
                    <xd:ul>
                        <xd:li><xd:p><xd:b>XSLT 1.0 template utilites for MARC21</xd:b></xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Created on:</xd:b>August, 19, 2004</xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Author:</xd:b>Nate Trail</xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Modified on:</xd:b>December, 14, 2007</xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Author:</xd:b>Nate Trail</xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Modified on:</xd:b>February 16, 2023</xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Author:</xd:b>Carlos Martinez III</xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Modified on:</xd:b>May 22, 2023</xd:p></xd:li>
                    </xd:ul>
                    <xd:ul>
                        <xd:li><xd:p><xd:b>XSLT 2.0 functions for MARC21</xd:b></xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Created on:</xd:b>October 27, 2022</xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Author</xd:b>Carlos Martinez III</xd:p></xd:li>
                    </xd:ul>
                    <xd:ul>
                        <xd:li><xd:p><xd:b>NAL XSLT Custom functions</xd:b></xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Created on:</xd:b>October 27, 2022</xd:p></xd:li>
                        <xd:li><xd:p><xd:b>Author</xd:b>Carlos Martinez III</xd:p></xd:li>
                    </xd:ul>
                </xd:li>
    ...
    <!-- 11/10/23: cmartinez added exception to local:stripPunctuation for authors using single letter initial as forename -->
    ...
    <!-- Local functions -->
    <xd:doc>
        <xd:desc> Strips punctuation from the last character of a field. To extend add any
            additional punctuation to the punctuation variable $str: string to be analyzed </xd:desc>
        <xd:param name="str"/>
    </xd:doc>
    ...
    <xd:doc>
        <xd:desc> Strips punctuation from the last character of a field, this version accepts two
            parameters: $str: string to be striped $pcodes: optional punctuation to override the
            defualt, if empty uses defualts </xd:desc>
        <xd:param name="str"/>
    ...
    <xd:doc>
        <xd:desc> Concats specified subfields in order they appear in marc record Two prameters
            $datafield: marc:datafield node to use for processing $codes: list of subfield codes, no
            spaces </xd:desc>
    ...
    <xd:doc>
        <xd:desc> Concats specified subfields in order they appear in marc record with specified
            delimiter Three parameters $datafield: marc:datafield node to use for processing $codes:
            list of subfield codes, no spaces $delimiter: delimiter to use when concating subfields,
            if empty a space is used </xd:desc>
        <xd:param name="datafield"/>
        <xd:param name="codes"/>
    ...
    <xd:doc>
        <xd:desc> Concats specified subfields based on siblings $anyCode: the subfield you want to
            select on $axis: the that beforeCodes and afterCodes are computed $beforeCodes:
            subfields that occure before the axis $afterCodes: subfields that occure after the axis </xd:desc>
        <xd:param name="datafield"/>
...
<!-- local call templates for XSLT 1.0 -->
 ...
 <!--NAL Custom Functions by Carlos Martinez III-->
        ...
        <xd:desc>
            ...
            <xd:p>
                <xd:ul>
                    ...
                    <xd:li>
                        <xd:i>3.<xd:ref name="f:decodeMARCCountry" type="function"/>f:decodeMARCCountry</xd:i>
                    </xd:li>
                    <xd:li>
                    ...
                    <xd:li>
                        <xd:i>6.<xd:ref name="f:isoTwo2One" type="function"/>f:isoOne2Two</xd:i>
                    </xd:li>
                    <xd:li>
                        <xd:i>7.<xd:ref name="f:isoTwo2Lang" type="function"/>f:isoTwo2Lang</xd:i>
                    </xd:li>                    
                    <xd:li>
                        <xd:i>8.<xd:ref name="f:capitalize-first" type="function"/>f:capitalize-first</xd:i>
                    </xd:li>
                    <xd:li>
                        <xd:i>9.<xd:ref name="f:sentence-case" type="function"/>f:sentence-case</xd:i>
                    </xd:li>
                    <xd:li>
                        <xd:i>10.<xd:ref name="f:f:proper-case" type="function"/>f:f:proper-case</xd:i>
                    </xd:li>
                    <xd:li>
                        <xd:i>11.<xd:ref name="f:substring-before-match" type="function"/>f:substring-before-match</xd:i>
                    </xd:li>
                    <xd:li>
                        <xd:i>12.<xd:ref name="f:nameIdentifier" type="function"/>f:nameIdentifier</xd:i>
                    </xd:li>
                    <xd:li>
                        <xd:i>13.<xd:ref name="f:isNumber" type="function"/>f:isNumber</xd:i>
                    </xd:li>
                </xd:ul>
            </xd:p>
        </xd:desc>
    ...
    <xsl:function name="local:isoTwo2One" as="xs:string">
        <xsl:param name="isoTwo"/>
        <xsl:variable name="nodes">
            <xsl:copy-of select="document('commons/iso639.xml')"/>
        </xsl:variable>
